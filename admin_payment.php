            ...
            <div class='container'>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <button class="btn"  data-title="Confirm order" data-toggle="modal" data-target="#modify" onclick="location.href='neworder.php';"> New Order</button>
                        <button class="btn "  data-title="Delete" data-toggle="modal" data-target="#delete" onclick="location.href='comorder.php';"> Confirmed Order</button>
                    </div>
                </div>
            </div>
        </div>
